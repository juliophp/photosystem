			...
			<div class="row main">
				...
				<div class="main-login main-center" style="background-color: #d3d3d3;">
					<form class="form-horizontal" method="post" action="">
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="username" id="username"  placeholder="Enter User Username" />
								</div>
							</div>
						</div>
						...
						<div class="form-group ">
							<button type="submit" class="btn btn-success btn-md btn-block login-button">Add User</button>
						</div>
					</form>
				</div>
			</div>
